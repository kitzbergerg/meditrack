...
public class RoleController {
    ...
    public RoleDto create(@Validated(CreateValidator.class) @RequestBody RoleDto dto) {
        ...
        try {
            ...
            log.error("NotFoundException: POST /api/role/{} {}", dto.id(), dto, e);
            throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Error during creating role: " + e.getMessage(), e);
        }
    }
