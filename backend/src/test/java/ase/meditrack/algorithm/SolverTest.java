...
class SolverTest {
    ...
    void simpleTest() {
        List<EmployeeInfo> employeeInfos =
                List.of(new EmployeeInfo(List.of(0), 28 * 8 - 20, 28 * 8 + 20, 28 * 8, Set.of(), Set.of(), 0));
    ...
    void testCanWorkShift() {
        ...
        List<EmployeeInfo> employeeInfos =
                List.of(new EmployeeInfo(List.of(), 28 * 8 - 20, 28 * 8 + 20, 28 * 8, Set.of(), Set.of(), 0));
        ...
        employeeInfos = List.of(new EmployeeInfo(List.of(0), 28 * 8 - 20, 28 * 8 + 20, 28 * 8, Set.of(), Set.of(), 0));
    ...
    void testMaxWorkingHours() {
        ...
        List<EmployeeInfo> employeeInfos =
                List.of(new EmployeeInfo(List.of(0), 28 * 6, 28 * 12 - 1, 28 * 8, Set.of(), Set.of(), 0));
        ...
        // 28 * 12 -> solution
        employeeInfos =
                List.of(new EmployeeInfo(List.of(0), 28 * 6, 28 * 12, 28 * 8, Set.of(), Set.of(), 0));
    ...
    void testHoliday() {
        ...
        employeeInfos.add(new EmployeeInfo(List.of(0), 28 * 8 - 20, 28 * 8 + 20, 28 * 8, Set.of(0), Set.of(), 0));
        List<ShiftTypeInfo> shiftTypeInfos = List.of(new ShiftTypeInfo(LocalTime.of(8, 0), LocalTime.of(20, 0), 12));
        List<RoleInfo> roles = List.of(new RoleInfo("Rolename", 0, 0));
        AlgorithmInput input = new AlgorithmInput(28, employeeInfos, shiftTypeInfos, roles, 1, 0);
        assertTrue(SchedulingSolver.solve(input).isEmpty());
        ...
        employeeInfos.add(new EmployeeInfo(List.of(0), 28 * 8 - 20, 28 * 8 + 20, 28 * 8, Set.of(), Set.of(), 0));
        input = new AlgorithmInput(28, employeeInfos, shiftTypeInfos, roles, 1, 0);
        assertTrue(SchedulingSolver.solve(input).isPresent());
    }
    ...
    void testRequiredPeople() {
        ...
        employeeInfos.add(new EmployeeInfo(List.of(0, 1), 28 * 8 - 20, 28 * 8 + 20, 28 * 8, Set.of(), Set.of(), 0));
        assertTrue(SchedulingSolver.solve(input).isPresent());
    }
